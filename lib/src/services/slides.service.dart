...
class SlideService {
  ...
  final List<SlideModel> _slidesData = [
    SlideModel(img: 'assets/images/main.png', imgHeight: 220, text: 'Hola amigo FanPet, bienvenido a la aplicación que te permitirá llevar en tu bolsillo toda información de tu mascota.'),
